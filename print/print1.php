...
c/o Steve Widget</textarea>-->
		...
		<table id="items">
		  ...
		  <tr class="item-row">
		      ...
		      <td><textarea class="cost"><?php $z="amt".($i+1); echo $_POST[$z];?></textarea></td>
		      <!--<td><input type="text" hidden class="qty" value="1"></td>
		      <td><span class="price"><?php $z="amt".($i+1); echo $_POST[$z];?></span></td>-->
		  </tr>
