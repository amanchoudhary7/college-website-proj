...
<script src="http://code.jquery.com/jquery-1.10.2.js"></script>
  ...
  if(isset($_POST['submit']))
  {
	...
	$sql="INSERT INTO patient(adm_date,patient_id,patient_name,fh_name,dob,cdate,email,mobile,address,amount,remarks,billNumber,op_charge) VALUES ('".$adm_date."','".$patient_id."','".$pname."','".$fhname."','".$dob."','".$cdate."','".$email."','".$mobile."','".$address."','".$ammount."','".$remarks."','".$billNumber."','".$op_charge."')";
	//echo $sql;
