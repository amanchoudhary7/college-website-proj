...
<div class="form-group">
									...
									<div class="form-group">
    <label class="col-sm-3 control-label no-padding-right" for="form-field-6"> Title of Paper </label>
    <div class="col-sm-9">
        <input type="text" id="form-field-6" name="booktitle" placeholder="Enter Title of Paper" class="col-xs-10 col-sm-5" />
    </div>
</div>
