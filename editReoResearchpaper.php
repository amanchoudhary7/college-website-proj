							...
							<div class="col-xs-12">
                                ...
                                <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" name="faculty_scientist" value="<?php echo $row['Faculty']; ?>" placeholder="Enter Faculty/Scientist Name" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-3" name="employee_id" value="<?php echo $row['Employee ID']; ?>" placeholder="Enter Employee ID" class="col-xs-5 col-sm-3" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-4" name="author_name" value="<?php echo $row['Author']; ?>" placeholder="Enter Author's Name" class="col-xs-10 col-sm-5" />
