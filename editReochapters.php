...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Chapters in Edited Volumes - Amity University</title>
							...
							<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" name="department" value="<?php echo $row['Department']; ?>" placeholder="Enter Department Name" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-3" name="emp_id" value="<?php echo $row['Employee ID']; ?>" placeholder="Enter Employee ID" class="col-xs-5 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="clearfix">
												<input type="text" id="form-field-5" name="coauthor" value="<?php echo $row['Co-author']; ?>" placeholder="Enter Corresponding/Co-author's Name" class="col-xs-5" />
											</div>
											<div class="space-2"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="booktitle" value="<?php echo $row['booktitle']; ?>" placeholder="Enter Title of Book Chapter" class="col-xs-10 col-sm-5" />
											<div class="space-2"></div>
										</div>
									</div>
										...
										<div class="col-xs-12 col-sm-4">
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Chapters in Edited Volumes/Books Submission</h4>
